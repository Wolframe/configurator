/********************************************************************************
** Form generated from reading UI file 'component_edit.ui'
**
...
#ifndef UI_COMPONENT_EDIT_H
#define UI_COMPONENT_EDIT_H
...
public:
    ...
    void setupUi(QWidget *component_edit_form)
    {
        if (component_edit_form->objectName().isEmpty())
            component_edit_form->setObjectName(QString::fromUtf8("component_edit_form"));
        component_edit_form->resize(460, 1004);
        component_edit_form->setProperty("initAction", QVariant(QString::fromUtf8("read")));
        component_edit_form->setProperty("id", QVariant(QString::fromUtf8("{global.id}")));
        component_edit_form->setProperty("doctype", QVariant(QString::fromUtf8("ComponentRequest.simpleForm")));
        component_edit_form->setProperty("rootelement", QVariant(QString::fromUtf8("component")));
        formLayout = new QFormLayout(component_edit_form);
        formLayout->setObjectName(QString::fromUtf8("formLayout"));
        formLayout->setFieldGrowthPolicy(QFormLayout::AllNonFixedFieldsGrow);
        label_code = new QLabel(component_edit_form);
        label_code->setObjectName(QString::fromUtf8("label_code"));

        formLayout->setWidget(1, QFormLayout::LabelRole, label_code);

        code = new QLineEdit(component_edit_form);
        ...
        label_manufacturer = new QLabel(component_edit_form);
        ...
        manufacturer = new QTableWidget(component_edit_form);
        ...
        save = new QPushButton(component_edit_form);
        save->setObjectName(QString::fromUtf8("save"));
        save->setProperty("rootelement", QVariant(QString::fromUtf8("component")));
        save->setProperty("doctype", QVariant(QString::fromUtf8("Component.simpleform")));
        save->setProperty("action", QVariant(QString::fromUtf8("update")));
        save->setProperty("form", QVariant(QString::fromUtf8("components")));
        save->setProperty("id", QVariant(QString::fromUtf8("{global.id}")));

        horizontalLayout->addWidget(save);

        reset = new QPushButton(component_edit_form);
        reset->setObjectName(QString::fromUtf8("reset"));
        reset->setProperty("doctype", QVariant(QString::fromUtf8("ComponentRequest.simpleform")));
        reset->setProperty("rootelement", QVariant(QString::fromUtf8("component")));
        ...
        cancel = new QPushButton(component_edit_form);
        ...
        label_description_2 = new QLabel(component_edit_form);
        ...
        label_3 = new QLabel(component_edit_form);
        label_3->setObjectName(QString::fromUtf8("label_3"));

        horizontalLayout_2->addWidget(label_3);

        search = new QLineEdit(component_edit_form);
        search->setObjectName(QString::fromUtf8("search"));

        horizontalLayout_2->addWidget(search);

        searchButton = new QPushButton(component_edit_form);
        ...
        label = new QLabel(component_edit_form);
        label->setObjectName(QString::fromUtf8("label"));

        formLayout->setWidget(10, QFormLayout::LabelRole, label);

        label_2 = new QLabel(component_edit_form);
        label_2->setObjectName(QString::fromUtf8("label_2"));
        label_2->setPixmap(QPixmap(QString::fromUtf8(":/images/brick_edit.png")));

        formLayout->setWidget(0, QFormLayout::LabelRole, label_2);

        label_4 = new QLabel(component_edit_form);
        ...
        retranslateUi(component_edit_form);
        QObject::connect(search, SIGNAL(returnPressed()), searchButton, SLOT(click()));

        QMetaObject::connectSlotsByName(component_edit_form);
    } // setupUi

    void retranslateUi(QWidget *component_edit_form)
    {
        component_edit_form->setWindowTitle(QApplication::translate("component_edit_form", "Edit component", 0, QApplication::UnicodeUTF8));
        label_code->setText(QApplication::translate("component_edit_form", "Code:", 0, QApplication::UnicodeUTF8));
        label_name->setText(QApplication::translate("component_edit_form", "Name:", 0, QApplication::UnicodeUTF8));
        label_category->setText(QApplication::translate("component_edit_form", "Category:", 0, QApplication::UnicodeUTF8));
        QTreeWidgetItem *___qtreewidgetitem = category->headerItem();
        ___qtreewidgetitem->setText(1, QApplication::translate("component_edit_form", "description", 0, QApplication::UnicodeUTF8));
        ___qtreewidgetitem->setText(0, QApplication::translate("component_edit_form", "category", 0, QApplication::UnicodeUTF8));
        category->setProperty("doctype", QVariant(QApplication::translate("component_edit_form", "CategoryHierarchyRequest.simpleform", 0, QApplication::UnicodeUTF8)));
        category->setProperty("rootelement", QVariant(QApplication::translate("component_edit_form", "category", 0, QApplication::UnicodeUTF8)));
        label_manufacturer->setText(QApplication::translate("component_edit_form", "Manufacturer", 0, QApplication::UnicodeUTF8));
        QTableWidgetItem *___qtablewidgetitem = manufacturer->horizontalHeaderItem(0);
        ___qtablewidgetitem->setText(QApplication::translate("component_edit_form", "thumbnail", 0, QApplication::UnicodeUTF8));
        QTableWidgetItem *___qtablewidgetitem1 = manufacturer->horizontalHeaderItem(1);
        ___qtablewidgetitem1->setText(QApplication::translate("component_edit_form", "name", 0, QApplication::UnicodeUTF8));
        label_mfgCode->setText(QApplication::translate("component_edit_form", "mfgCode:", 0, QApplication::UnicodeUTF8));
        label_description->setText(QApplication::translate("component_edit_form", "Webpage:", 0, QApplication::UnicodeUTF8));
        save->setText(QApplication::translate("component_edit_form", "Save", 0, QApplication::UnicodeUTF8));
        reset->setText(QApplication::translate("component_edit_form", "Reset", 0, QApplication::UnicodeUTF8));
        cancel->setText(QApplication::translate("component_edit_form", "Cancel", 0, QApplication::UnicodeUTF8));
        label_description_2->setText(QApplication::translate("component_edit_form", "Description:", 0, QApplication::UnicodeUTF8));
        label_price->setText(QApplication::translate("component_edit_form", "Price:", 0, QApplication::UnicodeUTF8));
        QTableWidgetItem *___qtablewidgetitem2 = picture->horizontalHeaderItem(0);
        ___qtablewidgetitem2->setText(QApplication::translate("component_edit_form", "thumbnail", 0, QApplication::UnicodeUTF8));
        QTableWidgetItem *___qtablewidgetitem3 = picture->horizontalHeaderItem(1);
        ___qtablewidgetitem3->setText(QApplication::translate("component_edit_form", "caption", 0, QApplication::UnicodeUTF8));
        QTableWidgetItem *___qtablewidgetitem4 = picture->horizontalHeaderItem(2);
        ___qtablewidgetitem4->setText(QApplication::translate("component_edit_form", "info", 0, QApplication::UnicodeUTF8));
        QTableWidgetItem *___qtablewidgetitem5 = picture->horizontalHeaderItem(3);
        ___qtablewidgetitem5->setText(QApplication::translate("component_edit_form", "tags", 0, QApplication::UnicodeUTF8));
        label_3->setText(QApplication::translate("component_edit_form", "Filter pictures by:", 0, QApplication::UnicodeUTF8));
        searchButton->setText(QApplication::translate("component_edit_form", "Search..", 0, QApplication::UnicodeUTF8));
        label->setText(QApplication::translate("component_edit_form", "Pictures:", 0, QApplication::UnicodeUTF8));
        label_2->setText(QString());
        label_4->setText(QApplication::translate("component_edit_form", "Edit component..", 0, QApplication::UnicodeUTF8));
    } // retranslateUi

};

namespace Ui {
    class component_edit_form: public Ui_component_edit_form {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_COMPONENT_EDIT_H
