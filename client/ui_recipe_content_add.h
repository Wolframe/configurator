/********************************************************************************
** Form generated from reading UI file 'recipe_content_add.ui'
**
...
#ifndef UI_RECIPE_CONTENT_ADD_H
#define UI_RECIPE_CONTENT_ADD_H
...
class Ui_recipe_content_add_form
{
public:
    ...
    void setupUi(QWidget *recipe_content_add_form)
    {
        if (recipe_content_add_form->objectName().isEmpty())
            recipe_content_add_form->setObjectName(QString::fromUtf8("recipe_content_add_form"));
        recipe_content_add_form->resize(538, 347);
        recipe_content_add_form->setProperty("rootelement", QVariant(QString::fromUtf8("RecipeContent")));
        recipe_content_add_form->setProperty("recipe_id", QVariant(QString::fromUtf8("{global.recipe_id}")));
        recipe_content_add_form->setProperty("category_id", QVariant(QString::fromUtf8("{global.category_id}")));
        gridLayout = new QGridLayout(recipe_content_add_form);
        gridLayout->setObjectName(QString::fromUtf8("gridLayout"));
        horizontalLayout = new QHBoxLayout();
        horizontalLayout->setObjectName(QString::fromUtf8("horizontalLayout"));
        link = new QPushButton(recipe_content_add_form);
        ...
        cancel = new QPushButton(recipe_content_add_form);
        ...
        label_2 = new QLabel(recipe_content_add_form);
        label_2->setObjectName(QString::fromUtf8("label_2"));
        label_2->setMaximumSize(QSize(32, 32));

        horizontalLayout_2->addWidget(label_2);

        label_3 = new QLabel(recipe_content_add_form);
        ...
        label_4 = new QLabel(recipe_content_add_form);
        ...
        label = new QLabel(recipe_content_add_form);
        ...
        ignore_expand_feats = new QRadioButton(recipe_content_add_form);
        ignore_expand_feats->setObjectName(QString::fromUtf8("ignore_expand_feats"));

        horizontalLayout_4->addWidget(ignore_expand_feats);

        ignore_collapse_feats = new QRadioButton(recipe_content_add_form);
        ...
        category = new QTreeWidget(recipe_content_add_form);
        ...
        recipe = new QTableWidget(recipe_content_add_form);
        ...
        label_requires = new QLabel(recipe_content_add_form);
        ...
        retranslateUi(recipe_content_add_form);
        ...
        QMetaObject::connectSlotsByName(recipe_content_add_form);
    } // setupUi

    void retranslateUi(QWidget *recipe_content_add_form)
    {
        recipe_content_add_form->setWindowTitle(QApplication::translate("recipe_content_add_form", "Add recipe content", 0, QApplication::UnicodeUTF8));
        recipe_content_add_form->setProperty("doctype", QVariant(QApplication::translate("recipe_content_add_form", "RecipeContentRequest.simpleform", 0, QApplication::UnicodeUTF8)));
        link->setText(QApplication::translate("recipe_content_add_form", "Add", 0, QApplication::UnicodeUTF8));
        link->setProperty("action", QVariant(QApplication::translate("recipe_content_add_form", "create", 0, QApplication::UnicodeUTF8)));
        cancel->setText(QApplication::translate("recipe_content_add_form", "Cancel", 0, QApplication::UnicodeUTF8));
        label_2->setText(QString());
        label_3->setText(QString());
        label_4->setText(QString());
        label->setText(QApplication::translate("recipe_content_add_form", "Add recipe content..", 0, QApplication::UnicodeUTF8));
        ignore_expand_feats->setText(QApplication::translate("recipe_content_add_form", "expand all", 0, QApplication::UnicodeUTF8));
        ignore_collapse_feats->setText(QApplication::translate("recipe_content_add_form", "collapse all", 0, QApplication::UnicodeUTF8));
        QTreeWidgetItem *___qtreewidgetitem = category->headerItem();
        ___qtreewidgetitem->setText(1, QApplication::translate("recipe_content_add_form", "description", 0, QApplication::UnicodeUTF8));
        ___qtreewidgetitem->setText(0, QApplication::translate("recipe_content_add_form", "category", 0, QApplication::UnicodeUTF8));
        QTableWidgetItem *___qtablewidgetitem = recipe->horizontalHeaderItem(0);
        ___qtablewidgetitem->setText(QApplication::translate("recipe_content_add_form", "name", 0, QApplication::UnicodeUTF8));
        QTableWidgetItem *___qtablewidgetitem1 = recipe->horizontalHeaderItem(1);
        ___qtablewidgetitem1->setText(QApplication::translate("recipe_content_add_form", "description", 0, QApplication::UnicodeUTF8));
        QTableWidgetItem *___qtablewidgetitem2 = recipe->horizontalHeaderItem(2);
        ___qtablewidgetitem2->setText(QApplication::translate("recipe_content_add_form", "categoryName", 0, QApplication::UnicodeUTF8));
        QTableWidgetItem *___qtablewidgetitem3 = recipe->horizontalHeaderItem(3);
        ___qtablewidgetitem3->setText(QApplication::translate("recipe_content_add_form", "creationDate", 0, QApplication::UnicodeUTF8));
        QTableWidgetItem *___qtablewidgetitem4 = recipe->horizontalHeaderItem(4);
        ___qtablewidgetitem4->setText(QApplication::translate("recipe_content_add_form", "comment", 0, QApplication::UnicodeUTF8));
        label_requires->setText(QApplication::translate("recipe_content_add_form", "Requires:", 0, QApplication::UnicodeUTF8));
        label_min_requires->setText(QApplication::translate("recipe_content_add_form", "min.", 0, QApplication::UnicodeUTF8));
        label_max_requires->setText(QApplication::translate("recipe_content_add_form", "max.", 0, QApplication::UnicodeUTF8));
    } // retranslateUi

};

namespace Ui {
    class recipe_content_add_form: public Ui_recipe_content_add_form {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_RECIPE_CONTENT_ADD_H
