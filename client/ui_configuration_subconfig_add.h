/********************************************************************************
** Form generated from reading UI file 'configuration_subconfig_add.ui'
**
...
#ifndef UI_CONFIGURATION_SUBCONFIG_ADD_H
#define UI_CONFIGURATION_SUBCONFIG_ADD_H
...
class Ui_configuration_subconfig_add_form
{
public:
    ...
    void setupUi(QWidget *configuration_subconfig_add_form)
    {
        if (configuration_subconfig_add_form->objectName().isEmpty())
            configuration_subconfig_add_form->setObjectName(QString::fromUtf8("configuration_subconfig_add_form"));
        configuration_subconfig_add_form->resize(538, 320);
        gridLayout = new QGridLayout(configuration_subconfig_add_form);
        gridLayout->setObjectName(QString::fromUtf8("gridLayout"));
        horizontalLayout = new QHBoxLayout();
        horizontalLayout->setObjectName(QString::fromUtf8("horizontalLayout"));
        link = new QPushButton(configuration_subconfig_add_form);
        ...
        cancel = new QPushButton(configuration_subconfig_add_form);
        ...
        label_2 = new QLabel(configuration_subconfig_add_form);
        label_2->setObjectName(QString::fromUtf8("label_2"));
        label_2->setMaximumSize(QSize(32, 32));

        horizontalLayout_2->addWidget(label_2);

        label_3 = new QLabel(configuration_subconfig_add_form);
        ...
        label_4 = new QLabel(configuration_subconfig_add_form);
        label_4->setObjectName(QString::fromUtf8("label_4"));
        label_4->setMaximumSize(QSize(32, 32));

        horizontalLayout_2->addWidget(label_4);

        label = new QLabel(configuration_subconfig_add_form);
        ...
        configuration = new QTableWidget(configuration_subconfig_add_form);
        ...
        subconfig = new QTableWidget(configuration_subconfig_add_form);
        ...
        subconfig->setProperty("state", QVariant(QString::fromUtf8("{global.subconfigState}")));
        ...
        label_requires = new QLabel(configuration_subconfig_add_form);
        ...
        quantity = new QSpinBox(configuration_subconfig_add_form);
        ...
        retranslateUi(configuration_subconfig_add_form);

        QMetaObject::connectSlotsByName(configuration_subconfig_add_form);
    } // setupUi

    void retranslateUi(QWidget *configuration_subconfig_add_form)
    {
        configuration_subconfig_add_form->setWindowTitle(QApplication::translate("configuration_subconfig_add_form", "Add subconfigs of configuration", 0, QApplication::UnicodeUTF8));
        link->setText(QApplication::translate("configuration_subconfig_add_form", "Add", 0, QApplication::UnicodeUTF8));
        link->setProperty("action", QVariant(QApplication::translate("configuration_subconfig_add_form", "create", 0, QApplication::UnicodeUTF8)));
        cancel->setText(QApplication::translate("configuration_subconfig_add_form", "Cancel", 0, QApplication::UnicodeUTF8));
        label_2->setText(QString());
        label_3->setText(QString());
        label_4->setText(QString());
        label->setText(QApplication::translate("configuration_subconfig_add_form", "Add subconfigs of configuration..", 0, QApplication::UnicodeUTF8));
        QTableWidgetItem *___qtablewidgetitem = configuration->horizontalHeaderItem(0);
        ___qtablewidgetitem->setText(QApplication::translate("configuration_subconfig_add_form", "categoryName", 0, QApplication::UnicodeUTF8));
        QTableWidgetItem *___qtablewidgetitem1 = configuration->horizontalHeaderItem(1);
        ___qtablewidgetitem1->setText(QApplication::translate("configuration_subconfig_add_form", "name", 0, QApplication::UnicodeUTF8));
        QTableWidgetItem *___qtablewidgetitem2 = configuration->horizontalHeaderItem(2);
        ___qtablewidgetitem2->setText(QApplication::translate("configuration_subconfig_add_form", "description", 0, QApplication::UnicodeUTF8));
        QTableWidgetItem *___qtablewidgetitem3 = configuration->horizontalHeaderItem(3);
        ___qtablewidgetitem3->setText(QApplication::translate("configuration_subconfig_add_form", "comment", 0, QApplication::UnicodeUTF8));
        QTableWidgetItem *___qtablewidgetitem4 = subconfig->horizontalHeaderItem(0);
        ___qtablewidgetitem4->setText(QApplication::translate("configuration_subconfig_add_form", "categoryName", 0, QApplication::UnicodeUTF8));
        QTableWidgetItem *___qtablewidgetitem5 = subconfig->horizontalHeaderItem(1);
        ___qtablewidgetitem5->setText(QApplication::translate("configuration_subconfig_add_form", "name", 0, QApplication::UnicodeUTF8));
        QTableWidgetItem *___qtablewidgetitem6 = subconfig->horizontalHeaderItem(2);
        ___qtablewidgetitem6->setText(QApplication::translate("configuration_subconfig_add_form", "description", 0, QApplication::UnicodeUTF8));
        QTableWidgetItem *___qtablewidgetitem7 = subconfig->horizontalHeaderItem(3);
        ___qtablewidgetitem7->setText(QApplication::translate("configuration_subconfig_add_form", "comment", 0, QApplication::UnicodeUTF8));
        label_requires->setText(QApplication::translate("configuration_subconfig_add_form", "Quantity:", 0, QApplication::UnicodeUTF8));
    } // retranslateUi

};

namespace Ui {
    class configuration_subconfig_add_form: public Ui_configuration_subconfig_add_form {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_CONFIGURATION_SUBCONFIG_ADD_H
