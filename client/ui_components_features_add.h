/********************************************************************************
** Form generated from reading UI file 'components_features_add.ui'
**
...
#ifndef UI_COMPONENTS_FEATURES_ADD_H
#define UI_COMPONENTS_FEATURES_ADD_H
...
class Ui_components_features_add_form
{
public:
    ...
    void setupUi(QWidget *components_features_add_form)
    {
        if (components_features_add_form->objectName().isEmpty())
            components_features_add_form->setObjectName(QString::fromUtf8("components_features_add_form"));
        components_features_add_form->resize(538, 387);
        components_features_add_form->setProperty("rootelement", QVariant(QString::fromUtf8("ComponentFeature")));
        components_features_add_form->setProperty("component_id", QVariant(QString::fromUtf8("{global.component_id}")));
        components_features_add_form->setProperty("feature_id", QVariant(QString::fromUtf8("{global.feature_id}")));
        gridLayout = new QGridLayout(components_features_add_form);
        gridLayout->setObjectName(QString::fromUtf8("gridLayout"));
        horizontalLayout = new QHBoxLayout();
        horizontalLayout->setObjectName(QString::fromUtf8("horizontalLayout"));
        link = new QPushButton(components_features_add_form);
        ...
        cancel = new QPushButton(components_features_add_form);
        ...
        label_2 = new QLabel(components_features_add_form);
        ...
        label_3 = new QLabel(components_features_add_form);
        ...
        label_4 = new QLabel(components_features_add_form);
        ...
        label = new QLabel(components_features_add_form);
        ...
        ignore_expand_feats = new QRadioButton(components_features_add_form);
        ignore_expand_feats->setObjectName(QString::fromUtf8("ignore_expand_feats"));

        horizontalLayout_4->addWidget(ignore_expand_feats);

        ignore_collapse_feats = new QRadioButton(components_features_add_form);
        ...
        feature = new QTreeWidget(components_features_add_form);
        ...
        component = new QTableWidget(components_features_add_form);
        ...
        label_requires = new QLabel(components_features_add_form);
        ...
        label_7 = new QLabel(components_features_add_form);
        ...
        retranslateUi(components_features_add_form);
        ...
        QMetaObject::connectSlotsByName(components_features_add_form);
    } // setupUi

    void retranslateUi(QWidget *components_features_add_form)
    {
        components_features_add_form->setWindowTitle(QApplication::translate("components_features_add_form", "Add a component/feature link", 0, QApplication::UnicodeUTF8));
        components_features_add_form->setProperty("doctype", QVariant(QApplication::translate("components_features_add_form", "ComponentFeatureRequest.simpleform", 0, QApplication::UnicodeUTF8)));
        link->setText(QApplication::translate("components_features_add_form", "Add", 0, QApplication::UnicodeUTF8));
        link->setProperty("action", QVariant(QApplication::translate("components_features_add_form", "create", 0, QApplication::UnicodeUTF8)));
        cancel->setText(QApplication::translate("components_features_add_form", "Cancel", 0, QApplication::UnicodeUTF8));
        label_2->setText(QString());
        label_3->setText(QString());
        label_4->setText(QString());
        label->setText(QApplication::translate("components_features_add_form", "New link of component and feature..", 0, QApplication::UnicodeUTF8));
        ignore_expand_feats->setText(QApplication::translate("components_features_add_form", "expand all", 0, QApplication::UnicodeUTF8));
        ignore_collapse_feats->setText(QApplication::translate("components_features_add_form", "collapse all", 0, QApplication::UnicodeUTF8));
        QTreeWidgetItem *___qtreewidgetitem = feature->headerItem();
        ___qtreewidgetitem->setText(1, QApplication::translate("components_features_add_form", "description", 0, QApplication::UnicodeUTF8));
        ___qtreewidgetitem->setText(0, QApplication::translate("components_features_add_form", "feature", 0, QApplication::UnicodeUTF8));
        QTableWidgetItem *___qtablewidgetitem = component->horizontalHeaderItem(0);
        ___qtablewidgetitem->setText(QApplication::translate("components_features_add_form", "code", 0, QApplication::UnicodeUTF8));
        QTableWidgetItem *___qtablewidgetitem1 = component->horizontalHeaderItem(1);
        ___qtablewidgetitem1->setText(QApplication::translate("components_features_add_form", "name", 0, QApplication::UnicodeUTF8));
        QTableWidgetItem *___qtablewidgetitem2 = component->horizontalHeaderItem(2);
        ___qtablewidgetitem2->setText(QApplication::translate("components_features_add_form", "categoryName", 0, QApplication::UnicodeUTF8));
        QTableWidgetItem *___qtablewidgetitem3 = component->horizontalHeaderItem(3);
        ___qtablewidgetitem3->setText(QApplication::translate("components_features_add_form", "manufacturerName", 0, QApplication::UnicodeUTF8));
        QTableWidgetItem *___qtablewidgetitem4 = component->horizontalHeaderItem(4);
        ___qtablewidgetitem4->setText(QApplication::translate("components_features_add_form", "mfgCode", 0, QApplication::UnicodeUTF8));
        QTableWidgetItem *___qtablewidgetitem5 = component->horizontalHeaderItem(5);
        ___qtablewidgetitem5->setText(QApplication::translate("components_features_add_form", "webPage", 0, QApplication::UnicodeUTF8));
        QTableWidgetItem *___qtablewidgetitem6 = component->horizontalHeaderItem(6);
        ___qtablewidgetitem6->setText(QApplication::translate("components_features_add_form", "description", 0, QApplication::UnicodeUTF8));
        QTableWidgetItem *___qtablewidgetitem7 = component->horizontalHeaderItem(7);
        ___qtablewidgetitem7->setText(QApplication::translate("components_features_add_form", "price", 0, QApplication::UnicodeUTF8));
        label_requires->setText(QApplication::translate("components_features_add_form", "Requires:", 0, QApplication::UnicodeUTF8));
        label_min_requires->setText(QApplication::translate("components_features_add_form", "min.", 0, QApplication::UnicodeUTF8));
        label_max_requires->setText(QApplication::translate("components_features_add_form", "max.", 0, QApplication::UnicodeUTF8));
        label_7->setText(QApplication::translate("components_features_add_form", "Provides:", 0, QApplication::UnicodeUTF8));
        label_min_provides->setText(QApplication::translate("components_features_add_form", "min.", 0, QApplication::UnicodeUTF8));
        label_max_provides->setText(QApplication::translate("components_features_add_form", "max.", 0, QApplication::UnicodeUTF8));
    } // retranslateUi

};

namespace Ui {
    class components_features_add_form: public Ui_components_features_add_form {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_COMPONENTS_FEATURES_ADD_H
