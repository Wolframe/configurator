/********************************************************************************
** Form generated from reading UI file 'categories_features_add.ui'
**
...
#ifndef UI_CATEGORIES_FEATURES_ADD_H
#define UI_CATEGORIES_FEATURES_ADD_H
...
class Ui_categories_features_add_form
{
public:
    ...
    void setupUi(QWidget *categories_features_add_form)
    {
        if (categories_features_add_form->objectName().isEmpty())
            categories_features_add_form->setObjectName(QString::fromUtf8("categories_features_add_form"));
        categories_features_add_form->resize(538, 387);
        gridLayout = new QGridLayout(categories_features_add_form);
        gridLayout->setObjectName(QString::fromUtf8("gridLayout"));
        horizontalLayout = new QHBoxLayout();
        horizontalLayout->setObjectName(QString::fromUtf8("horizontalLayout"));
        link = new QPushButton(categories_features_add_form);
        ...
        cancel = new QPushButton(categories_features_add_form);
        ...
        label_2 = new QLabel(categories_features_add_form);
        ...
        label_3 = new QLabel(categories_features_add_form);
        ...
        label_4 = new QLabel(categories_features_add_form);
        ...
        label = new QLabel(categories_features_add_form);
        ...
        ignore_expand_feats = new QRadioButton(categories_features_add_form);
        ignore_expand_feats->setObjectName(QString::fromUtf8("ignore_expand_feats"));

        horizontalLayout_4->addWidget(ignore_expand_feats);

        ignore_collapse_feats = new QRadioButton(categories_features_add_form);
        ...
        feature = new QTreeWidget(categories_features_add_form);
        ...
        category = new QTreeWidget(categories_features_add_form);
        ...
        ignore_expand_category = new QRadioButton(categories_features_add_form);
        ...
        ignore_collapse_cats = new QRadioButton(categories_features_add_form);
        ...
        label_requires = new QLabel(categories_features_add_form);
        ...
        label_7 = new QLabel(categories_features_add_form);
        ...
        retranslateUi(categories_features_add_form);
        ...
        QMetaObject::connectSlotsByName(categories_features_add_form);
    } // setupUi

    void retranslateUi(QWidget *categories_features_add_form)
    {
        categories_features_add_form->setWindowTitle(QApplication::translate("categories_features_add_form", "Add a category/feature link", 0, QApplication::UnicodeUTF8));
        link->setText(QApplication::translate("categories_features_add_form", "Add", 0, QApplication::UnicodeUTF8));
        link->setProperty("action", QVariant(QApplication::translate("categories_features_add_form", "create", 0, QApplication::UnicodeUTF8)));
        cancel->setText(QApplication::translate("categories_features_add_form", "Cancel", 0, QApplication::UnicodeUTF8));
        label_2->setText(QString());
        label_3->setText(QString());
        label_4->setText(QString());
        label->setText(QApplication::translate("categories_features_add_form", "New link of category and feature..", 0, QApplication::UnicodeUTF8));
        ignore_expand_feats->setText(QApplication::translate("categories_features_add_form", "expand all", 0, QApplication::UnicodeUTF8));
        ignore_collapse_feats->setText(QApplication::translate("categories_features_add_form", "collapse all", 0, QApplication::UnicodeUTF8));
        QTreeWidgetItem *___qtreewidgetitem = feature->headerItem();
        ___qtreewidgetitem->setText(1, QApplication::translate("categories_features_add_form", "description", 0, QApplication::UnicodeUTF8));
        ___qtreewidgetitem->setText(0, QApplication::translate("categories_features_add_form", "feature", 0, QApplication::UnicodeUTF8));
        QTreeWidgetItem *___qtreewidgetitem1 = category->headerItem();
        ___qtreewidgetitem1->setText(1, QApplication::translate("categories_features_add_form", "description", 0, QApplication::UnicodeUTF8));
        ___qtreewidgetitem1->setText(0, QApplication::translate("categories_features_add_form", "category", 0, QApplication::UnicodeUTF8));
        category->setProperty("rootelement", QVariant(QApplication::translate("categories_features_add_form", "category", 0, QApplication::UnicodeUTF8)));
        ignore_expand_category->setText(QApplication::translate("categories_features_add_form", "expand all", 0, QApplication::UnicodeUTF8));
        ignore_collapse_cats->setText(QApplication::translate("categories_features_add_form", "collapse all", 0, QApplication::UnicodeUTF8));
        label_requires->setText(QApplication::translate("categories_features_add_form", "Requires:", 0, QApplication::UnicodeUTF8));
        label_min_requires->setText(QApplication::translate("categories_features_add_form", "min.", 0, QApplication::UnicodeUTF8));
        label_max_requires->setText(QApplication::translate("categories_features_add_form", "max.", 0, QApplication::UnicodeUTF8));
        label_7->setText(QApplication::translate("categories_features_add_form", "Provides:", 0, QApplication::UnicodeUTF8));
        label_min_provides->setText(QApplication::translate("categories_features_add_form", "min.", 0, QApplication::UnicodeUTF8));
        label_max_provides->setText(QApplication::translate("categories_features_add_form", "max.", 0, QApplication::UnicodeUTF8));
    } // retranslateUi

};

namespace Ui {
    class categories_features_add_form: public Ui_categories_features_add_form {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_CATEGORIES_FEATURES_ADD_H
